...
start:
	clr r16				; r16 <- 00 zera o registrador 16 para transformar portb em entrada
	...
	lsr r18	;lsr desloca os bits mais significativos
	lsr r18	;para a direita, preenchendo com 0 a direita
	lsr r18
	lsr r18
